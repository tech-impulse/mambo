...
function getDescripcionAviso(codigo, accion) {
    ...
    if (lang == "ES") {
        ...
        case "existenBorradores":
            document.getElementById('pedidosDialogTituloAC').innerHTML = "Información";
            document.getElementById('pedidosDialogTextAC').innerHTML = "¿Existen otros borradores generados en base a escaner. Desea anadir los nuevos artículos a estos borradores o generar nuevos borradores?";
            document.getElementById('btnPedidosDialogOkAC').innerHTML = "Si";
            document.getElementById('btnPedidosDialogCancelAC').innerHTML = "No";
            document.getElementById("pedidosDialogIconoAC").src = "images/verde.png";
        ...
        case "eliminarPlantilla":
            document.getElementById('pedidosDialogTituloAC').innerHTML = "Aviso";
            document.getElementById('pedidosDialogTextAC').innerHTML = "<center>¿Desea eliminar la plantilla actual?</center>";
            document.getElementById('btnPedidosDialogOkAC').innerHTML = "Si";
            document.getElementById('btnPedidosDialogCancelAC').innerHTML = "No";
            document.getElementById("pedidosDialogIconoAC").src = "images/amarillo.png";
            document.getElementById("pedidosDialogACOrden").innerHTML = "eliminarPlantilla";
            break;
        ...
        case "eliminarPedido":
            document.getElementById('pedidosDialogTituloAC').innerHTML = "Aviso";
            document.getElementById('pedidosDialogTextAC').innerHTML = "<center>¿Do you Want to delete this order?</center>";
            document.getElementById('btnPedidosDialogOkAC').innerHTML = "Yes";
            document.getElementById('btnPedidosDialogCancelAC').innerHTML = "No";
            document.getElementById("pedidosDialogIconoAC").src = "images/amarillo.png";
            document.getElementById("pedidosDialogACOrden").innerHTML = "eliminarPedido";
        ...
        case "eliminarPlantilla":
            document.getElementById('pedidosDialogTituloAC').innerHTML = "Aviso";
            document.getElementById('pedidosDialogTextAC').innerHTML = "<center>¿Do you want to delete this template?</center>";
            document.getElementById('btnPedidosDialogOkAC').innerHTML = "Yes";
            document.getElementById('btnPedidosDialogCancelAC').innerHTML = "No";
            document.getElementById("pedidosDialogIconoAC").src = "images/amarillo.png";
            document.getElementById("pedidosDialogACOrden").innerHTML = "eliminarPlantilla";
